...
INSERT INTO tb_wallet (id, user_id, balance, created_at, updated_at, version) VALUES ('w0000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 150.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
-- Maria com R$200,00 de saldo
INSERT INTO tb_wallet (id, user_id, balance, created_at, updated_at, version) VALUES ('w0000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 200.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
-- Pedro com R$50,00 de saldo
INSERT INTO tb_wallet (id, user_id, balance, created_at, updated_at, version) VALUES ('w0000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 50.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
-- Admin com R$500,00 de saldo
INSERT INTO tb_wallet (id, user_id, balance, created_at, updated_at, version) VALUES ('w0000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000001', 500.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

-- ==================== TRANSACOES DA WALLET ====================
-- Recargas do Joao
INSERT INTO tb_wallet_transaction (id, wallet_id, type, amount, balance_after, description, reference_id, created_at) VALUES ('t0000000-0000-0000-0000-000000000001', 'w0000000-0000-0000-0000-000000000001', 'CREDIT', 200.00, 200.00, 'Recarga de saldo via PIX', null, CURRENT_TIMESTAMP);
INSERT INTO tb_wallet_transaction (id, wallet_id, type, amount, balance_after, description, reference_id, created_at) VALUES ('t0000000-0000-0000-0000-000000000002', 'w0000000-0000-0000-0000-000000000001', 'DEBIT', 50.00, 150.00, 'Pedido #ord00001', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01', CURRENT_TIMESTAMP);
-- Recargas da Maria
INSERT INTO tb_wallet_transaction (id, wallet_id, type, amount, balance_after, description, reference_id, created_at) VALUES ('t0000000-0000-0000-0000-000000000003', 'w0000000-0000-0000-0000-000000000002', 'CREDIT', 300.00, 300.00, 'Recarga de saldo via PIX', null, CURRENT_TIMESTAMP);
INSERT INTO tb_wallet_transaction (id, wallet_id, type, amount, balance_after, description, reference_id, created_at) VALUES ('t0000000-0000-0000-0000-000000000004', 'w0000000-0000-0000-0000-000000000002', 'DEBIT', 100.00, 200.00, 'Pedido #ord00002', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02', CURRENT_TIMESTAMP);
...
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000001', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1', 'Hamburguer Artesanal', 'https://img.stadium.com/hamburguer.jpg', 1, 25.90);
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000002', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb1', 'Cerveja 600ml', 'https://img.stadium.com/cerveja.jpg', 1, 15.00);
-- Pedido 2 (Maria): Combo Familia + Agua
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000003', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02', 'dddddddd-dddd-dddd-dddd-ddddddddddd2', 'Combo Familia', 'https://img.stadium.com/combo2.jpg', 1, 55.00);
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000004', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb3', 'Agua Mineral 500ml', 'https://img.stadium.com/agua.jpg', 1, 5.00);
-- Pedido 3 (Joao): Camisa Oficial
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000005', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03', 'cccccccc-cccc-cccc-cccc-ccccccccccc1', 'Camisa Oficial 2025', 'https://img.stadium.com/camisa.jpg', 1, 299.90);
-- Pedido 4 (Pedro): Pipoca + Refri
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000006', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3', 'Pipoca Grande', 'https://img.stadium.com/pipoca.jpg', 1, 12.00);
INSERT INTO tb_order_item (id, order_id, product_id, product_name, product_img_url, quantity, price) VALUES ('f0000000-0000-0000-0000-000000000007', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb2', 'Refrigerante 350ml', 'https://img.stadium.com/refri.jpg', 1, 8.00);

-- ==================== PAGAMENTOS ====================
-- Pagamento Pedido 1 (Joao - WALLET - APPROVED)
INSERT INTO tb_payment (id, order_id, user_id, amount, method, status, gateway_transaction_id, gateway_response, created_at, updated_at, version) VALUES ('p0000000-0000-0000-0000-000000000001', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01', '10000000-0000-0000-0000-000000000001', 40.90, 'WALLET', 'APPROVED', null, 'Pagamento via wallet aprovado', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
-- Pagamento Pedido 2 (Maria - WALLET - APPROVED)
INSERT INTO tb_payment (id, order_id, user_id, amount, method, status, gateway_transaction_id, gateway_response, created_at, updated_at, version) VALUES ('p0000000-0000-0000-0000-000000000002', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02', '10000000-0000-0000-0000-000000000002', 60.00, 'WALLET', 'APPROVED', null, 'Pagamento via wallet aprovado', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
-- Pagamento Pedido 3 (Joao - CREDIT_CARD - APPROVED)
INSERT INTO tb_payment (id, order_id, user_id, amount, method, status, gateway_transaction_id, gateway_response, created_at, updated_at, version) VALUES ('p0000000-0000-0000-0000-000000000003', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03', '10000000-0000-0000-0000-000000000001', 299.90, 'CREDIT_CARD', 'APPROVED', 'MP-TXN-20260428-001', 'Cartao aprovado via MercadoPago', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
-- Pagamento Pedido 4 (Pedro - PIX - PENDING)
INSERT INTO tb_payment (id, order_id, user_id, amount, method, status, gateway_transaction_id, gateway_response, created_at, updated_at, version) VALUES ('p0000000-0000-0000-0000-000000000004', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04', '10000000-0000-0000-0000-000000000003', 20.00, 'PIX', 'PENDING', 'MP-PIX-20260428-001', 'QR Code PIX gerado - aguardando pagamento', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);
